...
chassis_model.add_requirements(["transformers", "Pillow", "numpy", "torch", "timm"])
...
res = builder.build_image(name="detr-resnet-101-obj-detection", tag="0.0.2", show_logs=True)
end_time = time.time()
print(res)
