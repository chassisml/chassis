...
from chassisml.grpc_model import GRPC_SERVER_PORT as _GRPC_SERVER_PORT
from chassisml.grpc_model.src.auto_generated.model2_template.model_pb2 import (
    DESCRIPTOR,
    ModelDescription,
    ModelFeatures,
    ModelInfo,
...
from chassisml.model_lib.src.model import ExampleModel
